...
public class CalsDrive {
    ...
    public EditableCal FFangleDist = new EditableCal("FFangleDist", 24, false);
    public EditableCal FFanglePwrPerDeg = new EditableCal("FFanglePwr", 0.15, false);
