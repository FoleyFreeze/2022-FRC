...
public class CmdClimb extends SequentialCommandGroup{
    ...
    public CmdClimb(RobotContainer r){
        ...
        addCommands(new Release(r, sv, 0, this), 
                    ...
                    new ManArms(r, sv, 1, this), new Winch(r, sv, 2, this), //bar 2
                    new ManArms(r, sv, 3, this), new Winch(r, sv, 4, this), //bar 3
                    new ManArms(r, sv, 5, this), new Winch(r, sv, 6, this));//bar 4 (traversal)
    }
